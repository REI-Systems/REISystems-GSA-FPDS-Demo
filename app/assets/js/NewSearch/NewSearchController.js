...
controllers.NewSearchController = ['$scope', '$location', 'AuthProvider', 'usSpinnerService', 'SearchService', 'SessionFactory', 'ApiService', function($scope, $location, AuthProvider, usSpinnerService, SearchService, SessionFactory, ApiService){
